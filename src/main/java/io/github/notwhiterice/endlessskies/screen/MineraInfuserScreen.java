...
public class MineraInfuserScreen extends AbstractContainerScreen<MineralInfuserMenu> {
    ...
    public MineraInfuserScreen(MineralInfuserMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
